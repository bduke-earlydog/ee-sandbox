...
createApp({
  data() {
    return {
      ...
      searchQuery: '',
      options: [
        {exp:channel:categories category_group="8" style="linear"}
  ...
  methods: {
    ...
    fetchBlogData() {
      ...
      if (this.cache[cacheKey]) {
        ...
        const url = `/_news_json/blog/${this.headline_year}/${this.loadmoretrack}/${this.headline_search}/${this.headline_cat}`;
// alert(url)
